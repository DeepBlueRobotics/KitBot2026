...
public class ToLeftNeutralAuto extends SequentialCommandGroup {

  public ToLeftNeutralAuto(Drivetrain drivetrain, Outtake outtake, Intake intake, Conveyor conveyor, ArmIntake arm) {
