...
public class CenterToRightNeutralAuto extends SequentialCommandGroup {

  public CenterToRightNeutralAuto(Drivetrain drivetrain, Outtake outtake, Intake intake, Conveyor conveyor, ArmIntake arm) {
    addCommands(
