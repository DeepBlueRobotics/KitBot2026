...
//----------------------------------------------------------
    ...
    * Sets all swerve modules to X formation to prevent robot movement.
     ...
     */
    public void setX() {
        modules[0].move(0.001, 45);   // FL - points toward center-right
        modules[1].move(0.001, -45);  // FR - points toward center-left
        modules[2].move(0.001, -45);  // BL - points toward center-right
        modules[3].move(0.001, 45);   // BR - points toward center-left
        stop();
    }
